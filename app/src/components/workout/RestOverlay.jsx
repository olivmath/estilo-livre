    ...
    <div style={S.overlay}>
      ...
      <div style={{ position: "relative", width: 180, height: 180, marginBottom: 24 }}>
        <svg width="180" height="180" viewBox="0 0 180 180" style={{ transform: "rotate(-90deg)" }}>
          ...
          <circle
            ref={ringRef} cx="90" cy="90" r="82"
            fill="none" strokeWidth="6" stroke="var(--acc)" strokeLinecap="round"
            strokeDasharray={RING_CIRC} strokeDashoffset={0}
...
const S = {
  overlay: {
    ...
    zIndex: 100, background: "var(--bg)",
  },
  skipBtn: {
    padding: "14px 40px", borderRadius: 14, border: "1px solid var(--blue)",
