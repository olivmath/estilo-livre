...
const S = {
  overlay: {
    ...
    zIndex: 100, background: "var(--bg)", overflowY: "auto", padding: "60px 20px 32px",
  },
  statBox: {
    background: "var(--bg2)", borderRadius: 14, padding: "16px 10px",
    textAlign: "center", border: "1px solid var(--blue)",
  },
  sumItem: {
    display: "flex", alignItems: "center", gap: 10, padding: "10px 14px",
    borderRadius: 12, background: "rgba(0,200,83,0.06)", border: "1px solid rgba(0,200,83,0.2)",
  },
  skipBtn: {
    padding: "14px 20px", borderRadius: 14, border: "1px solid var(--blue)",
    background: "var(--bg2)", color: "var(--sub)", fontSize: 14, fontWeight: 600, cursor: "pointer",
  },
  ctaBtn: {
    padding: 17, borderRadius: 15, border: "none",
